...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-2">
                        ...
                        <span class="font-bold text-xl text-gray-800 dark:text-gray-200 hidden md:block">ElectronicSheet</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('files.index')" :active="request()->routeIs('files.*')" wire:navigate>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('files.index')" :active="request()->routeIs('files.*')" wire:navigate>
                {{ __('Files') }}
            </x-responsive-nav-link>
            @if(auth()->user()->isAdmin())
